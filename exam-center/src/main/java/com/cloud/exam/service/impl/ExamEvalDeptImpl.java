...
import com.cloud.exam.service.ExamEvalDeptService;
...
@Service
@Transactional
public class ExamEvalDeptImpl extends ServiceImpl<ExamEvalDeptDao, ExamEvalDept> implements ExamEvalDeptService {
