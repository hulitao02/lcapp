...
import com.cloud.core.Constant;
...
public class VideoRecord  {
    ...
    public VideoRecord(String fileName, boolean isHaveDevice) {
       ...
       /* Constant.WIDTH = Toolkit.getDefaultToolkit().getScreenSize().width;
        Constant.HEIGHT =Toolkit.getDefaultToolkit().getScreenSize().height;*/
