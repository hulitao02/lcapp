...
public interface FileDao {
	...
	@Insert("insert into file_info(id, name, isImg, contentType, size, path, url, source, createTime,useTimes) "
			+ "values(#{id}, #{name}, #{isImg}, #{contentType}, #{size}, #{path}, #{url}, #{source}, #{createTime},#{useTimes})")
