...
public abstract class LogModule {
    ...
    public static final String DEL_QUESTION="DEL_QUESTION";
    ...
    static {
        ...
        MODULES.put(ADD_QUESTION,"添加试题");
        MODULES.put(UPDATE_QUESTION,"修改试题");
        MODULES.put(DEL_QUESTION,"删除试题");

        MODULES.put(ADD_EXAM,"修改活动");
