...
//				Object map = authenticationToken.getPrincipal();
	...
	public static Long getLoginUserId() {
		...
		return loginAppUser == null ? null : loginAppUser.getId();
	}

	public static Long getLoginDepartmentId() {
		LoginAppUser loginAppUser = getLoginAppUser();
		return loginAppUser == null ? null : loginAppUser.getDepartmentId();
	}
}
