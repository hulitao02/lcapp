...
public final class PermitAllUrl {
    ...
    private static final String[] ENDPOINTS = {
            ...
            "/**/oauth/**","/actuator/health", "/actuator/env", "/actuator/metrics/**", "/actuator/trace", "/actuator/dump",
            ...
            "/v2/api-docs/**", "/swagger-ui.html", "/swagger-resources/**", "/webjars/**","/getImageAnnotionQuestion"};
